...
def train_unseen(model, train_loader, optimizer, criterion, epochs, device, loss_names, clip_gradient_at=0.0,
          fetch_model_data=single_input_single_output, feed_model_data=basic_forward,
          initial_epoch=1, mtll_model=None, print_raw_losses=False,num_main_losses=None, **kwargs):
